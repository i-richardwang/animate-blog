...
image: https://imrichard.com/wp-content/uploads/2024/04/python-plotly-sankey-diagram-cover.avif
---
...
![使用 Python Pandas 创建的模拟员工原始绩效数据表格的前五行截图](https://imrichard.com/wp-content/uploads/2025/04/employee-performance-raw-data-head.avif)
...
![经过分组和计数汇总后的员工绩效流动统计数据表格，包含源、目标和计数列](https://imrichard.com/wp-content/uploads/2025/04/employee-performance-aggregated-flow-data.avif)
...
![桑基图数据准备步骤的打印输出结果（节点、链接、流量）](https://imrichard.com/wp-content/uploads/2025/04/plotly-sankey-node-link-data-preparation-output.avif)
...
![使用 Python Plotly 绘制的员工两年绩效流动桑基图，展示了从第一年绩效到第二年状态的人数流动情况](https://imrichard.com/wp-content/uploads/2025/04/python-plotly-employee-performance-sankey-chart.webp)
...
这篇文章详细介绍了使用 Python 的 Plotly 库绘制桑基图的整个过程，包括了从理解桑基图是什么、准备数据，到具体的代码编写、颜色设置和图表调整。我们还用一个员工绩效流动的模拟例子，实际操作了这些步骤，并说明了如何看懂最后生成的图表。

掌握桑基图的绘制不仅能让数据报告更加美观直观，还能帮助我们更好地发掘数据流动中的规律和关联。Plotly 丰富的交互功能和定制选项，让我们能轻松创建专业的桑基图。希望这篇教程能帮助你在数据分析工作中运用桑基图，实现更有效的数据沟通。
