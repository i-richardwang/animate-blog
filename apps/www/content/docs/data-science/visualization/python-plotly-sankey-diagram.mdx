...
![使用 Python Pandas 创建的模拟员工原始绩效数据表格的前五行截图](/images/docs/data-science/employee-performance-raw-data-head.webp)
...
![经过分组和计数汇总后的员工绩效流动统计数据表格，包含源、目标和计数列](/images/docs/data-science/employee-performance-aggregated-flow-data.webp)
...
![桑基图数据准备步骤的打印输出结果（节点、链接、流量）](/images/docs/data-science/plotly-sankey-node-link-data-preparation-output.webp)
...
![使用 Python Plotly 绘制的员工两年绩效流动桑基图，展示了从第一年绩效到第二年状态的人数流动情况](/images/docs/data-science/python-plotly-employee-performance-sankey-chart.webp)
