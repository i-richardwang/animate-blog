...
![Python 生成的初始员工模拟数据预览，包含年份、员工ID和姓名。](/images/docs/data-science/python-employee-basic-data-sample-scaled.webp)
...
![添加了组织信息（如部门、岗位）的员工模拟数据示例。](/images/docs/data-science/python-employee-data-with-org-info-scaled.webp)
...
![增加了员工级别和当前级别停留时长信息的模拟数据预览。](/images/docs/data-science/python-employee-data-with-level-tenure-scaled.webp)
...
![展示了模拟晋升流程各环节（如是否提名、是否成功）的数据示例。](/images/docs/data-science/python-employee-promotion-decision-sample-scaled.webp)
...
![最终完成格式化的员工晋升模拟数据集预览，可见级别已处理。](/images/docs/data-science/final-formatted-employee-promotion-data-scaled.webp)
