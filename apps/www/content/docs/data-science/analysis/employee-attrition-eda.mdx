...
<Tabs defaultValue="plotly">
  ...
  <TabsContents>
    <TabsContent value="plotly">
      ![Plotly 绘制的 Attrition 标签分布柱状图与饼图，显示类别不平衡。](/images/docs/data-science/eda_label_distribution_plotly.webp)
    ...
    <TabsContent value="matplotlib">
      ![Matplotlib 绘制的 Attrition 标签分布柱状图与饼图，显示类别不平衡。](/images/docs/data-science/eda_label_distribution_matplotlib.webp)
...
<Tabs defaultValue="plotly">
  ...
  <TabsContents>
    <TabsContent value="plotly">
      ![Plotly 绘制的各特征与 Attrition 的相关性系数条形图](/images/docs/data-science/eda_correlation_coefficient_plotly-scaled.webp)
    ...
    <TabsContent value="matplotlib">
      ![Matplotlib 绘制的各特征与 Attrition 的相关性系数条形图](/images/docs/data-science/eda_correlation_coefficient_matplotlib-scaled.webp)
...
<Tabs defaultValue="plotly">
  ...
  <TabsContents>
    <TabsContent value="plotly">
      ![Plotly 绘制的 Age 在不同 Attrition 状态下的直方图与KDE曲线](/images/docs/data-science/eda_continuous_feature_distribution_plotly.webp)
    ...
    <TabsContent value="matplotlib">
      ![Matplotlib 绘制的 Age 在不同 Attrition 状态下的直方图与KDE曲线](/images/docs/data-science/eda_continuous_feature_distribution_matplotlib.webp)
...
<Tabs defaultValue="plotly">
  ...
  <TabsContents>
    <TabsContent value="plotly">
      ![Plotly 绘制的按 Department 分组的员工数与流失率](/images/docs/data-science/eda_discrete_feature_distribution_plotly.webp)
    ...
    <TabsContent value="matplotlib">
      ![Matplotlib 绘制的按 Department 分组的员工数与流失率](/images/docs/data-science/eda_discrete_feature_distribution_matplotlib.webp)
...
<Tabs defaultValue="plotly">
  ...
  <TabsContents>
    <TabsContent value="plotly">
      ![Plotly 绘制的 DistanceFromHome 在不同 MaritalStatus 与 Attrition 组合下的箱线图比较。](/images/docs/data-science/eda_feature_combination_boxplot_plotly.webp)
    ...
    <TabsContent value="matplotlib">
      ![Matplotlib 绘制的 DistanceFromHome 在不同 MaritalStatus 与 Attrition 组合下的箱线图比较。](/images/docs/data-science/eda_feature_combination_boxplot_matplotlib.webp)
...
![按 MaritalStatus 分别绘制的 DistanceFromHome KDE曲线](/images/docs/data-science/eda_feature_combination_kde_plotly.webp)
...
![Plotly 绘制的 Age & MonthlyIncome 与标签的等高线图](/images/docs/data-science/eda_feature_combination_contour_plotly.webp)
