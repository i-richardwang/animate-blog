...
![示例数据库表 emp_data 的结构定义及前3行数据预览](/images/docs/ai/sql-table-schema-info.webp)
...
![大模型根据"查询员工平均年龄"问题生成的 SQL 查询语句](/images/docs/ai/llm-generated-sql-query.webp)
...
![执行 SQL 查询员工平均年龄后，数据库返回的原始结果](/images/docs/ai/raw-sql-query-result.webp)
...
![大模型将查询结果处理后生成的关于"员工平均年龄"的最终中文回答](/images/docs/ai/llm-natural-language-answer.webp)
